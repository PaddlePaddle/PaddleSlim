...
# done
nohup python smoothwanda.py /root/.paddlenlp/models/facebook/llama-7b wikitext2 --sparsity_ratio 0.4375 --rho 2.1 --nbits 8 --saved_path '/mnt/disk3/cym/JSQ-paddle/llama-7b-paddle-1' > llama-7b-paddle.log 2>&1 &
# python smoothwanda.py /root/.paddlenlp/models/facebook/llama-7b wikitext2 --sparsity_ratio 0.4375 --rho 2.1 --nbits 8 --saved_path '/mnt/disk3/cym/JSQ-paddle/llama-7b-paddle'
