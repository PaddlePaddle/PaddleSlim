...
QuantizationConfig.__new__.__defaults__ = (None, ) * len(QuantizationConfig._fields)
 
### DistillationConfig:
DistillationConfig = namedtuple("DistillationConfig", [
...
DistillationConfig.__new__.__defaults__ = (None, ) * len(DistillationConfig._fields)
 
### 多teacher蒸馏配置
### Multi-Teacher DistillationConfig：
MultiTeacherDistillationConfig = namedtuple("MultiTeacherDistillationConfig", [
...
MultiTeacherDistillationConfig.__new__.__defaults__ = (None, ) * len(MultiTeacherDistillationConfig._fields)
 
### 不设置就按照默认的搜索空间进行超参搜索，设置的话按照设置的搜索空间搜索，这样可以支持单PTQ策略
###HyperParameterOptimizationConfig:
HyperParameterOptimizationConfig = namedtuple("HyperParameterOptimizationConfig", [
"ptq_algo",
"bias_correct",
...
HyperParameterOptimizationConfig.__new__.__defaults__ = (None, ) * len(HyperParameterOptimizationConfig._fields)
