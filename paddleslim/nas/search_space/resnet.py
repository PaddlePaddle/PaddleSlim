...
class ResNetSpace(SearchSpaceBase):
    def __init__(self, input_size, output_size, block_num, extract_feature=False, class_dim=1000):
    ...
    def token2arch(self,tokens=None):
        ...
        def net_arch(input):
            ...
            conv = conv_bn_layer(input=input, filter_size=5, num_filters=filter1, stride=2, act='relu')
