...
def eval(args):
    ...
    eval_loader = paddle.io.DataLoader(val_dataset, batch_size=args.batch_size,
            drop_last=True)
    ...
    for batch_id, data in enumerate(eval_loader()):
        ...
        if batch_id % 10 == 0:
            ...
            print("batch_id {}, acc1 {:.3f}, acc5 {:.3f}, avg time {:.5f} sec/img".format(
                batch_id, acc1, acc5, avg_time))
