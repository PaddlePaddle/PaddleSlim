...
You can directly modify MODEL_DIR and DATA_DIR in `run.sh` under `/PATH_TO_PaddleSlim/demo/mkldnn_quant/quant_aware/` directory, then you can execute `./run.sh` for CPU prediction.
