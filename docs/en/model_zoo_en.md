...
|             Model              |      Method       |  Dataset   | Image/GPU | Input 608 Box AP | Input 416 Box AP | Input 320 Box AP | Model Size(MB) | GFLOPs (608*608) | PaddleLite cost(ms) | TensorRT speed(FPS) |              Download                           |
| :----------------------------: | :---------------: | :--------: | :-------: | :--------------: | :--------------: | :--------------: | :------------: | :--------------: | :--------------: | :--------------: | :----------------------------: |
|      MobileNet-V1-YOLOv3       |     Baseline      | Pascal VOC |     8     |       76.2       |       76.7       |       75.3       |       94       |      40.49       | 374.083\236.649\143.476 |-| [model](https://paddlemodels.bj.bcebos.com/object_detection/yolov3_mobilenet_v1_voc.tar) |
|      MobileNet-V1-YOLOv3       | sensitive -52.88% | Pascal VOC |     8     |   77.6 (+1.4)    |    77.7 (1.0)    |   75.5 (+0.2)    |       31       |      19.08       | 172.322\98.623\55.937 |-| [model](https://paddlemodels.bj.bcebos.com/PaddleSlim/yolov3_mobilenet_v1_voc_prune.tar) |
...
| :-------: | :---------------: | :-----------: | :--------------: | :----: | :--------------: | :----: |  :-------------------: |
| fast-scnn |     baseline      |     69.64     |        11        | 14.41  | 1226.36\682.96\415.664 |-| [model](https://paddlemodels.bj.bcebos.com/PaddleSlim/fast_scnn_cityscape.tar) |
| fast-scnn | uniform  -17.07%  | 69.58 (-0.06) |       8.5        | 11.95  | 1140.37\656.612\415.888 |-| [model](https://paddlemodels.bj.bcebos.com/PaddleSlim/fast_scnn_cityscape_uniform-17.tar) |
| fast-scnn | sensitive -47.60% | 66.68 (-2.96) |       5.7        |  7.55  | 866.693\494.467\291.748 |-| [model](https://paddlemodels.bj.bcebos.com/PaddleSlim/fast_scnn_cityscape_sensitive-47.tar) |
